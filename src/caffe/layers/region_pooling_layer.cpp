...
void RegionPoolingLayer<Dtype>::Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  //LOG(INFO) << "pheight " << pooled_height_ << ", stride_h_ " << stride_h_ << ", height_ " << height_ << ", pad_h_ " << pad_h_;
  //LOG(INFO) << "pwidth " << pooled_width_ << ", stride_w_ " << stride_w_ << ", width_ " << width_ << ", pad_w_ " << pad_w_;
  if (pad_h_ || pad_w_) {
  ...
  //LOG(INFO) << "height " << pooled_height_;
  ...
  //LOG(INFO) << "+ooling height " << height_;
}
